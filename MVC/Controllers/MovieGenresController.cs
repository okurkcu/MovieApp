...
namespace MVC.Controllers
{
    ...
    {
        // Service injections:
        private readonly IMovieGenresService _movieGenreService;
        ...
        public IActionResult Create(MovieGenresModel movieGenre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(MovieGenresModel movieGenre)
        {
            if (ModelState.IsValid)
            {
